...
drop table IF EXISTS upfall;
drop table IF EXISTS gov_unit;
drop table IF EXISTS owner;
drop table IF EXISTS pivot;
drop table IF EXISTS postgre_example;
drop table IF EXISTS parent_example;
drop table IF EXISTS township;
drop table IF EXISTS county;
drop table IF EXISTS state;
drop table IF EXISTS fall_location;
drop table IF EXISTS fall_description;
drop table IF EXISTS new_falls;
drop table IF EXISTS other_unit;
...
insert into gov_unit values (7,3,'Ontonogan','County');
insert into gov_unit values (8,7,'Interior','Township');
insert into gov_unit values (9,3,'Dickenson','County');
...
insert into county values (7,'Ontonogan',7818);
insert into county values (9,'Dickenson',27472);
...
insert into upfall values (13,'Kakibika Falls',null,null,null,null,null,10,'y',null,
